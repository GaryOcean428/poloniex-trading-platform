...
**Provenance:** Streamlined/excerpted from authoritative source `/home/braden/Desktop/Dev/QIG_QFI/qig-verification/docs/20260527-canonical-principles-2.31A.md` (mtime 2026-05-27 18:14:06.913751315 +0800, fresh read 2026-05-27 during this planning turn). Full 25 principles, two-axis schema, budget model, anti-principles, dependency map, and cross-cutting (Warp) are in the original. This is a convenience reference only.

**DO NOT EDIT THIS FILE WITHOUT GOVERNANCE.** Per AGENTS.md "QIG PURITY MANDATE FOR THIS SYSTEM" (permanent architectural law): any edit requires master-orchestration + re-read of exact QIG_QFI path + _dev__polytrade_ packets + qig-purity-validation gate + verification-before-completion evidence. Authority is always the QIG_QFI original.
