...
**End of QIG mandate section. The rest of this file (Railway/Railpack best practices) remains as-is for non-QIG work. For any QIG or Polytrade kernel work, the above overrides and must be followed first.**
