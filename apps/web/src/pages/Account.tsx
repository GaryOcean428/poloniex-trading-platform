...
const Account: React.FC = () => {
  ...
  const accountData = {
    ...
    weeklyPnL: bal && bal.weeklyPnL != null ? parseFloat(String(bal.weeklyPnL)) : undefined,
    monthlyPnL: bal && bal.monthlyPnL != null ? parseFloat(String(bal.monthlyPnL)) : undefined,
    lifetimePnL: bal && bal.lifetimePnL != null ? parseFloat(String(bal.lifetimePnL)) : undefined,
    depositsPending: 0,
