...
// The SLE is secondary (a sandbox for genome experimentation); live
// trading runs through the Monkey kernel at 60s cadence. Keep a 5-min
// backstop here so genome exploration still advances.
