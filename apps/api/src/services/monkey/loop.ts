...
export class MonkeyKernel extends EventEmitter {
  ...
  pushReward(input: {
    ...
    const dop = proposed.valid ? proposed.dopamineDelta : 0;
    const ser = proposed.valid ? proposed.serotoninDelta : 0;
    const endo = proposed.valid ? proposed.endorphinDelta : 0;
