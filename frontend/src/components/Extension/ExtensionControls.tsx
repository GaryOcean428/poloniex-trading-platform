      ...
      <div className="border-b">
        <nav className="flex divide-x">
          <button
            ...
            className={`flex-1 py-2 px-3 flex justify-center items-center text-sm font-medium ${activePanel === 'status' ? 'bg-blue-50 text-blue-600' : 'bg-neutral-50 text-neutral-600 hover:bg-neutral-100'
              }`}
          >
            Status
          </button>
          <button
            ...
            className={`flex-1 py-2 px-3 flex justify-center items-center text-sm font-medium ${activePanel === 'settings' ? 'bg-blue-50 text-blue-600' : 'bg-neutral-50 text-neutral-600 hover:bg-neutral-100'
              }`}
          >
            Settings
          </button>
          <button
            ...
            className={`flex-1 py-2 px-3 flex justify-center items-center text-sm font-medium ${activePanel === 'info' ? 'bg-blue-50 text-blue-600' : 'bg-neutral-50 text-neutral-600 hover:bg-neutral-100'
              }`}
          >
            Info
          </button>
