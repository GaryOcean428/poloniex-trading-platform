...
const MockModeSettings: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-lg shadow p-6">
      <h2 className="text-xl font-semibold mb-4 text-neutral-800 dark:text-white">Mock Mode Settings</h2>
          ...
          <div className="relative inline-block w-12 mr-2 align-middle select-none">
            ...
            <label
              ...
              className={`toggle-label block overflow-hidden h-6 rounded-full cursor-pointer ${
                isMockMode ? 'bg-blue-500' : 'bg-neutral-300'
              }`}
            ></label>
          </div>
        </div>
      ...
      {isMockMode && (
        <>
          ...
          {showAdvanced && (
            <div className="bg-neutral-50 dark:bg-neutral-700 p-4 rounded-md mb-4">
              ...
              <div className="mb-3">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="use-random-seed" className="ml-2 block text-sm text-neutral-700 dark:text-neutral-300">
                    Use Random Seed
                  </label>
                </div>
              </div>
              ...
              <div className="mb-3">
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-neutral-300 rounded"
                  />
                  <label htmlFor="simulate-latency" className="ml-2 block text-sm text-neutral-700 dark:text-neutral-300">
              ...
              <div className="mb-3">
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-neutral-300 rounded"
                  />
                  <label htmlFor="simulate-errors" className="ml-2 block text-sm text-neutral-700 dark:text-neutral-300">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-4 py-2 bg-neutral-200 text-neutral-800 rounded-md hover:bg-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2 dark:bg-neutral-700 dark:text-white dark:hover:bg-neutral-600"
            >
              Reset to Defaults
            </button>
          </div>
